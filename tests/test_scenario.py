...
def test_discover_workbook_sources_sorts_and_defaults_to_latest():
    ...
    assert [source.report_month for source in sources] == ["2025-12", "2026-02", "2026-03", "2026-04", "2026-05", "2026-06", "2026-07", "2026-08"]

    latest = latest_workbook_source(sources)
    assert latest is not None
    assert latest.report_month == "2026-08"
    assert latest.timepoint_label == "2026-09-10"
    assert latest.path.name == "1000_20260831_20260910.xlsx"
